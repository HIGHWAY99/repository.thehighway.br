...
### Plugin Settings ###
def ps(x):
	if (x=='_addon_id') or (x=='addon_id') or (x=='_plugin_id') or (x=='plugin_id'): return 'plugin.video.thebinaryhighway'
	try: 
		return {
			'__plugin__': 					"The [B]Binary[/B] [COLOR tan]Highway[/COLOR] [I]00111001 00111001[/I]"
			...
			,'_addon_path_art': 		"art"
			,'_database_name': 			"thebinaryhighway"
			,'default_art_ext': 		'.png'

...
def ps(x):
	return {
		...
		,'LI.nextpage.check': 						'>&raquo;</a>'
		,'LI.page.param': 								'/page/'
		,'LI.page.find': 									'<a href="http://.+?/page/(\d+)/">\d+</a>'
